...
use crate::{
    ...
    lifecycle::{LanceDbStoreRequest, lancedb_store_dir, open_primary_table},
};
...
#[path = "hybrid_search_support.rs"]
mod hybrid_search_support;
use hybrid_search_support::{deduplicate_sections, expand_adjacent_chunks, sort_search_results};
